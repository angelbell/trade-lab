"""nas100_pullback.py -- spec card `scratchpad/spec_nas100_pullback.md` (仕様カード12).
...
Run:
  .venv/bin/python scratchpad/nas100_pullback.py --smoke
  .venv/bin/python scratchpad/nas100_pullback.py
"""
import argparse
import os
import sys
