...
Frozen spec card (2026-07-13). Reuses, does NOT reimplement:
  ...
  - scratchpad.book_spec_fix.build/book/w_trade/OLD/NEW  (the corrected 6-leg machine, tie-back gate)
  - scratchpad.book_leave_one_out.cdd                  (trade-resolution CAGR/DD)
  - scratchpad.short_mirror_15m.invert                 (price inversion for the short mirror, E4)
...
Run: .venv/bin/python scratchpad/btc_bo_kama_repair.py [--smoke]
"""
