...
Reuses (imports, does not reimplement):
  - scratchpad/btc_family_ext_throttle.py: build_base()          -- the 6 canonical leg series
  - scratchpad/book_leave_one_out.py: weights() / trade_series() / cdd() / stat()
...
Run (full):  .venv/bin/python scratchpad/book_weighting_scheme.py 2>/dev/null | tee scratchpad/out_book_weighting_scheme.txt
Run (smoke): .venv/bin/python scratchpad/book_weighting_scheme.py --smoke 2>/dev/null | tee scratchpad/out_book_weighting_scheme_smoke.txt
"""
