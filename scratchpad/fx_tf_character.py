...
Run: .venv/bin/python scratchpad/fx_tf_character.py           (full grid, tee to out_fx_tf_character.txt)
     .venv/bin/python scratchpad/fx_tf_character.py --smoke   (eurusd+xauusd, 1h+1d only)
"""
