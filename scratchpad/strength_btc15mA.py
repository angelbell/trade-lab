"""仕様カード scratchpad/spec_strength_btc15mA.md の実装。
...
車輪の再発明禁止 — 全て既存コードを import して使う:
  scratchpad/strength_btc15mL.py:
  ...
  scratchpad/strength_regime_btc15mL.py:
...
Run:
  .venv/bin/python scratchpad/strength_btc15mA.py --smoke 2>&1 | tee scratchpad/out_strength_btc15mA_smoke.txt
  .venv/bin/python scratchpad/strength_btc15mA.py 2>&1 | tee scratchpad/out_strength_btc15mA.txt
"""
import argparse
import contextlib
import io
...
def main():
    ...
    print(f"\n実行コマンド: .venv/bin/python scratchpad/strength_btc15mA.py"
