...
scratchpad/book_hh4h_weight_sweep.py / scratchpad/btc_family_ext_throttle.py -- the arbiter used
...
Reused (imported, not reimplemented):
  - scratchpad/btc_family_ext_throttle.py: build_base() (6 canonical legs), throttle(),
    ret4w_daily(), book_gen() (tie-back target)
  - scratchpad/book_hh4h_weight_sweep.py: ROOT, OLD/NEW basket lists
...
Run (full):  .venv/bin/python scratchpad/book_arbiter_v2.py
Run (smoke, fewer bootstrap draws): .venv/bin/python scratchpad/book_arbiter_v2.py --smoke
"""
