...
w_c=1min, H=5min, cost=$0.30/oz round trip, events = scratchpad/fomc_stmt_2019.csv (dt_broker).
...
from scratchpad.event_scalp import build_scalp_table, null_scalp_table, is_oos_table, COST_ROUNDTRIP
