...
Run:
  .venv/bin/python scratchpad/gap_curve_screen.py --smoke
  .venv/bin/python scratchpad/gap_curve_screen.py --instrument gold
  .venv/bin/python scratchpad/gap_curve_screen.py            # full run, all instruments
"""
import argparse
import sys
import time
...
def main():
    ...
    main_path = f"scratchpad/gap_curve_main{suffix}.csv"
    shape_path = f"scratchpad/gap_curve_shape{suffix}.csv"
    year_path = f"scratchpad/gap_curve_qualified_years{suffix}.csv"
