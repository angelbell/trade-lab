...
(data/ext_btc_oi_metrics.csv, built by scratchpad/binance_metrics_backfill.py) as a
...
def main():
    ...
    if not os.path.exists(METRICS_CSV):
        print(f"FATAL: {METRICS_CSV} not found -- run scratchpad/binance_metrics_backfill.py first.")
        sys.exit(1)
    ...
    print("\n" + "=" * 100)
    print("Building btc15m_L leg (exact reuse of scratchpad/btc15m_L_anatomy.py construction)")
    print("=" * 100)
    d15 = build_data()
