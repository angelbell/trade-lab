...
A. セットアップ・スナップショット: EURUSD 15分、C3(旗艦,狩り+MSS+FVG/入口FVG-CE/損切りL-0.1ATR/
   ...
   重ねる。ファイル: scratchpad/fig_ict_setups_<era>_<n>.png
...
B. 正規化した経路の中央値: 同じ C3 母集団の全トレードについて、約定を基準(x=0)に0-100本の
   ...
   0R・-1R(損切り)・目標R(中央値)の水平線つき。ファイル: scratchpad/fig_ict_path_by_era.png

C. MFE/MAE散布図: ict_alpha_decay.scan_mfe_mae(C3,E1)の結果を年代別に色分けして散布。
   ファイル: scratchpad/fig_ict_mfe_mae.png
...
Run: .venv/bin/python scratchpad/ict_figures.py [--smoke]
"""
...
OUT = "/home/angelbell/dev/auto-trade/scratchpad"
SEED = 20260716
