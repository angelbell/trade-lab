"""usdjpy_1h_funnel.py -- funnel test for the ONE tension cell found by scratchpad/d2_fx_reexam.py:
...
Run:
  .venv/bin/python scratchpad/usdjpy_1h_funnel.py --smoke     (2018-> subset, gate (a) only)
  .venv/bin/python scratchpad/usdjpy_1h_funnel.py             (full history, all steps)
Tee to scratchpad/out_usdjpy_funnel.txt (done by the caller / via `| tee`).
"""
