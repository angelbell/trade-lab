...
実行:
  .venv/bin/python scratchpad/event_scalp.py --smoke   # 直近2年
  .venv/bin/python scratchpad/event_scalp.py           # フル
  .venv/bin/python scratchpad/event_scalp.py --events data/ext_cpi_dates.csv --draws 3000
"""
import argparse
import os
import sys
