"""仕様カード scratchpad/spec_entryquality_btc15mL.md の実装（パートA + パートB）。

btc15m_L 1本を scratchpad/strength_btc15mL.py の build()/rebuild_entries()/
...
Run:
  .venv/bin/python scratchpad/strength_entryquality_btc15mL.py --smoke 2>&1 | \\
      tee scratchpad/out_entryquality_btc15mL_smoke.txt
  .venv/bin/python scratchpad/strength_entryquality_btc15mL.py 2>&1 | \\
      tee scratchpad/out_entryquality_btc15mL.txt
"""
import argparse
import contextlib
import io
...
from scratchpad.strength_btc15mL import (
...
def main():
    ...
    print(f"\n実行コマンド: .venv/bin/python scratchpad/strength_entryquality_btc15mL.py"
