"""仕様カード scratchpad/spec_gold15m_standalone_improve.md の実装。
...
土台(照合ゲート): scratchpad/strength_gateslope_generalize.py の build_gold15m / gate1_check /
gate2_check と scratchpad/strength_btc15mL.py の rebuild_entries / match_entries_to_trades /
...
Run:
  .venv/bin/python scratchpad/gold15m_standalone_improve.py --smoke 2>&1 | tee scratchpad/out_gold15m_standalone_improve_smoke.txt
  .venv/bin/python scratchpad/gold15m_standalone_improve.py 2>&1 | tee scratchpad/out_gold15m_standalone_improve.txt
"""
import argparse
import contextlib
import io
...
def main():
    ...
    print(f"\n実行コマンド: .venv/bin/python scratchpad/gold15m_standalone_improve.py"
