...
前回(scratchpad/M_squeeze_screen.py)は btc15m_L / gold15m の2レッグのみで、押し目指値
...
Run:
  .venv/bin/python scratchpad/M_squeeze_matrix.py --smoke   # 直近データで先に通す
  .venv/bin/python scratchpad/M_squeeze_matrix.py           # フル(全銘柄xTF)
"""
