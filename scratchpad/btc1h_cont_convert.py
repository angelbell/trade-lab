...
Usage:
  .venv/bin/python scratchpad/btc1h_cont_convert.py            # smoke(2023) + full grid
  .venv/bin/python scratchpad/btc1h_cont_convert.py > scratchpad/out_btc1h_convert.txt 2>&1
"""
import os
import sys
import warnings
