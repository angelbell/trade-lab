...
experiments/trend_birth_meter.py, whose loading/KAMA/race/ground-truth code is imported directly).
...
Usage:
  .venv/bin/python experiments/birth_fire_discrim.py --smoke   # GOLD m15, 2024 only, F1 only
  .venv/bin/python experiments/birth_fire_discrim.py           # full run, both cells
"""
...
from experiments.trend_birth_meter import (kama, atr14, zigzag_pivots, build_uplegs, race_codes,
