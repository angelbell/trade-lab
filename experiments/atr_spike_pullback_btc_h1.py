...
Run:
  .venv/bin/python experiments/atr_spike_pullback_btc_h1.py --smoke 2>&1 | tee experiments/out_atr_spike_pullback_smoke.txt
  .venv/bin/python experiments/atr_spike_pullback_btc_h1.py 2>&1 | tee experiments/out_atr_spike_pullback_full.txt
"""
...
def main():
    ...
    out_csv_main = os.path.join(ROOT, "experiments",
    ...
    out_csv_sub = os.path.join(ROOT, "experiments",
    ...
    print(f"\n実行コマンド: .venv/bin/python experiments/atr_spike_pullback_btc_h1.py"
