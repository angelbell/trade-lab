...
Run (full):  .venv/bin/python experiments/gate_tf_ratio_gold.py 2>/dev/null | tee experiments/out_gate_tf_ratio_gold.txt
Run (smoke): .venv/bin/python experiments/gate_tf_ratio_gold.py --smoke 2>/dev/null | tee experiments/out_gate_tf_ratio_gold_smoke.txt
"""
