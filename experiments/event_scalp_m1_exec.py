...
Execution: .venv/bin/python experiments/event_scalp_m1_exec.py [--smoke]
"""
import argparse
import sys
import time
...
from experiments.fomc_event_study import atr14, price_before, candidate_dates
from experiments.event_scalp import build_scalp_table, null_scalp_table, COST_ROUNDTRIP, SEED
...
EVENTS_CSV = "experiments/fomc_stmt_2019.csv"
