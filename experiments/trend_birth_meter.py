...
Usage:
  .venv/bin/python experiments/trend_birth_meter.py --smoke   # GOLD 15m, 2024 only (mechanics)
  .venv/bin/python experiments/trend_birth_meter.py           # all 4 intraday cells
  .venv/bin/python experiments/trend_birth_meter.py --daily   # original daily cells (calendar-day units)
"""
