...
experiments/cache_taker_windows_24h.csv (re-runs free).
Run: .venv/bin/python experiments/taker_exit_sweep.py
"""
...
CACHE24 = os.path.join(ROOT, "experiments/cache_taker_windows_24h.csv")
