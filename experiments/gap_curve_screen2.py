...
v1 (experiments/gap_curve_screen.py) placed the stop at k*ATR(14) on the signal bar --
...
Run:
  .venv/bin/python experiments/gap_curve_screen2.py --smoke
  .venv/bin/python experiments/gap_curve_screen2.py --instrument gold
  .venv/bin/python experiments/gap_curve_screen2.py --instrument gold --median-t-only
"""
import argparse
import os
import sys
...
def main():
    ...
    main_path = f"experiments/gap_curve2_main{suffix}.csv"
    shape_path = f"experiments/gap_curve2_shape{suffix}.csv"
    year_path = f"experiments/gap_curve2_qualified_years{suffix}.csv"
