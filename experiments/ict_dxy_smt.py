...
Run: .venv/bin/python experiments/ict_dxy_smt.py [--smoke] 2>&1 | tee experiments/out_ict_dxy_smt.txt
"""
import sys, argparse
...
def main(smoke=False):
    ...
    print("  -> pairSMT の数値は ict_smt.py の自己検査出力（experiments/out_ict_smt_selfcheck.txt）と手動照合すること")
