"""(B) Two-instrument 15m parallel book:
  gold15m = gold 15m Pattern-B breakout + daily SMA150+slope gate + ext-cap8% + RR4,
            pullback-limit frac0.25, net abs spread $0.6  (machinery: experiments/pullback_fixedtgt.py)
  btc15m  = BTC 15m Pattern-B breakout + daily KAMA(14)-rising gate + RR4,
            pullback-limit frac0.3, net $15  (machinery: experiments/btc15m_pullback_gauntlet.py)
...
gsrc = open("/home/angelbell/dev/auto-trade/experiments/pullback_fixedtgt.py").read()
gns = {}
exec(gsrc.split("m=eval_market()")[0], gns)   # entries, d, h, l, c, FWD, stats, eval_market ...

# ---------- regenerate BTC 15m entries (canonical setup) ----------
bsrc = open("/home/angelbell/dev/auto-trade/experiments/btc15m_pullback_gauntlet.py").read()
bns = {}
