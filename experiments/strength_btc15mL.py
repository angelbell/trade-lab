"""仕様カード experiments/spec_strength_btc15mL.md の実装。
...
Run:
  .venv/bin/python experiments/strength_btc15mL.py --smoke 2>&1 | tee experiments/out_strength_btc15mL_smoke.txt
  .venv/bin/python experiments/strength_btc15mL.py 2>&1 | tee experiments/out_strength_btc15mL.txt
"""
import argparse
import contextlib
import io
...
def main():
    ...
    print(f"\n実行コマンド: .venv/bin/python experiments/strength_btc15mL.py"
