...
実行:
  .venv/bin/python experiments/event_kinetics.py --smoke   # 直近2年
  .venv/bin/python experiments/event_kinetics.py           # フル
  .venv/bin/python experiments/event_kinetics.py --events data/ext_cpi_dates.csv   # CPI/NFP等に流用
"""
import argparse
import os
import sys
