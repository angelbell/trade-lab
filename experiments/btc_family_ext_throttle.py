...
Run: .venv/bin/python experiments/btc_family_ext_throttle.py
Run (smoke, fewer bootstrap draws): .venv/bin/python experiments/btc_family_ext_throttle.py --smoke
"""
