...
Run:
  .venv/bin/python experiments/lab7_usdx.py --smoke
  .venv/bin/python experiments/lab7_usdx.py --full | tee experiments/out_lab7_usdx.txt
"""
import argparse
import sys
...
from experiments.lab_common import (forward_direction, forward_move, build_table,
