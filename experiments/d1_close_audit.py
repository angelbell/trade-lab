...
London) cell found in experiments/fx_flow_edges.py (2026-07-11 finding: all 6
...
Run:
    .venv/bin/python experiments/d1_close_audit.py --smoke   # 1yr smoke test
    .venv/bin/python experiments/d1_close_audit.py           # full run
"""
import argparse
import sys
