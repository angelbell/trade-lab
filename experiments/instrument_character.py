...
experiments/spec_instrument_character.md). Measures structural law 2 ("the instrument's
...
Run:
  .venv/bin/python experiments/instrument_character.py --smoke
  .venv/bin/python experiments/instrument_character.py                  (all instruments)
  .venv/bin/python experiments/instrument_character.py --only gold,BTC,USDJPY
"""
import argparse
import os
import sys
