...
Fetched window aggregates cached to experiments/cache_taker_proxy_windows.csv (re-runs are free).
Run: .venv/bin/python experiments/taker_proxy_validation.py
"""
...
CACHE_WIN = os.path.join(ROOT, "experiments/cache_taker_proxy_windows.csv")
