...
exit variants on the btc15m_L leg (same construction as experiments/btc15m_L_anatomy.py,
which itself copies experiments/pwh_adoption.py lines ~123-132 exactly).
