...
Frozen spec: experiments/spec_gold_fade_uptrend.md
...
same cap already used in experiments/reversal_beta_null.py's fade()).
...
Reuse, not reinvention:
  ...
  - experiments/reversal_beta_null.fade()             (tie-back: same walk order/tie-break,
...
def tieback_check(d, mask, cost=0.0):
    ...
    the REUSED experiments/reversal_beta_null.fade() function, on the SAME signal bars,
