...
body (experiments/usdjpy_1h_funnel.py: n=861, meanR net +0.074, totR/yr +2.39, maxDD 43.1R) is
...
Run:
  .venv/bin/python experiments/fx_htf_exit.py --smoke   (USDJPY 2018-> subset, E0+E1 only)
  .venv/bin/python experiments/fx_htf_exit.py            (full history, both entry sets, all cols)
Tee to experiments/out_fx_htf_exit.txt by the caller.
"""
