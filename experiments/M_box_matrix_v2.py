...
Run:
  .venv/bin/python experiments/M_box_matrix_v2.py --smoke
  .venv/bin/python experiments/M_box_matrix_v2.py
"""
...
def load_tr_signs(path="/home/angelbell/dev/auto-trade/experiments/out_squeeze_matrix_full.txt"):
    out = {}
    try:
        with open(path) as f:
            for line in f:
