...
ベース（変更禁止・ict_extliq_target.py の生存セル = ict_fvg_dsr_audit の凍結仕様と同一）:
  ...
  maxDD=21.7 (experiments/out_ict_extliq_target.txt に既存)。
...
Run: .venv/bin/python experiments/ict_weekly_gate_c1c2.py [--smoke] 2>&1 | tee experiments/out_ict_weekly_gate_c1c2.txt
"""
