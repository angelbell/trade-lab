...
STEP 2 rebuilds the 3 BTC book legs at their literal canon configs:
  ...
  btc15m_L    : radar_gate_race.BASE + gate_kama=14/gate_kama_tf=240min/pullback_frac=0.3,
                ...
                experiments/btc15m_L_anatomy.py lines ~30-48)
  btc15m_S    : short_mirror_15m.invert() + BASE + gate_kama=14 (1D gate) + pullback_frac=0.3,
                ...
                from experiments/short_mirror_15m.py)
...
Usage:
  .venv/bin/python experiments/btc1h_cont_redund.py --smoke 2023   # 1yr sanity check first
  .venv/bin/python experiments/btc1h_cont_redund.py                # full history
"""
import argparse
import os
import sys
