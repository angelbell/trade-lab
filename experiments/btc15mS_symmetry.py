...
Run:
  .venv/bin/python experiments/btc15mS_symmetry.py --smoke   (fast sanity pass, coarse only)
  .venv/bin/python experiments/btc15mS_symmetry.py           (full spec: S1-S4 + bootstrap)
"""
import argparse
import contextlib
import io
